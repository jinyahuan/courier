 ...
 */
@Slf4j
public class CourierHostLettuceDelegator extends AbstractCourierHostDelegator {
    private static final long serialVersionUID = 1L;

    protected ObjectPool<StatefulRedisConnection<String, String>> objectPool;

    public CourierHostLettuceDelegator(ObjectPool<StatefulRedisConnection<String, String>> objectPool) {
        super();
        this.objectPool = objectPool;
    }

    public CourierHostLettuceDelegator(String delegatorKeyName, ObjectPool objectPool) {
