 ...
 */
@Slf4j
public class CourierSupplierJedisDelegator extends AbstractCourierSupplierDelegator {
    private static final long serialVersionUID = 1L;

    protected Pool<Jedis> jedisPool;

    public CourierSupplierJedisDelegator(Pool jedisPool) {
        super();
        this.jedisPool = jedisPool;
    }

    public CourierSupplierJedisDelegator(Pool jedisPool, String delegatorKeyName) {
