 ...
 * @since 0.1
 */
public class CourierHostRandomChooser extends AbstractCourierHostChooser {
    protected volatile Random random;

    public CourierHostRandomChooser() {
        super();
    }

    public CourierHostRandomChooser(List<CourierHost> enableCourierHosts) {
