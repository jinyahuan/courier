 ...
 * @since 0.1
 */
public class CourierResponseNoOpInterceptor implements CourierResponseInterceptor {
    @Override
    public void intercept(CourierResponse response, CourierSupplier supplier) {}
}
